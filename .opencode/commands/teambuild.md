...
After building the team, persist the team a summary of its playstyle, to `teams/XXX-NAME-STRAT.md`. In that template, XXX is the next index within the directory, NAME is the slug of the Pokemon the team is built around, and STRAT is an extremely short description of the playstyle. Some examples of potential file names are:
