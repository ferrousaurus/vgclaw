---
description: Provides feedback on an existing VGC team for Pokemon Champions
agent: wolfey
...
Evaluate the following Pokemon Champions VGC team, written in Pokemon Showdown format:
