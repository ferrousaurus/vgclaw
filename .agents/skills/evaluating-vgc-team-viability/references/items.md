...
- **White Herb** -- Restores any lowered stats (one-time). Counters Intimidate on physical attackers. Also useful on Pokemon that lower their own stats (Close Combat, Overheat users).
...
- Consider whether the Mega form is worth giving up a flexible item slot on that Pokemon
...
4. **Champions has a limited item pool** -- No Choice Band, Choice Specs, Life Orb, Assault Vest, Safety Goggles, or many other mainline VGC staples. Type-boosting items and Focus Sash carry more weight here.
5. **Protect compatibility** -- Choice Scarf locks you into one move, preventing Protect. Make sure your Protect users don't hold Choice Scarf.
